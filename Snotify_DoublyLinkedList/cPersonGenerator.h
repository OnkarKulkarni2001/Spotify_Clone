...
public:
	...
	DLinkedList<sBaby> listBabies;
	DLinkedList<sSurname> listSurnames;
	DLinkedList<sStreet> listStreets;

	DLinkedList<std::string> ontarioCities;
	DLinkedList<std::string> quebecCities;
	DLinkedList<std::string> britishColumbiaCities;
	DLinkedList<std::string> albertaCities;
	DLinkedList<std::string> novaScotiaCities;
	DLinkedList<std::string> provinces;
};
